...
class ReservationController extends Controller
{
    ...
    public function index(Request $request)
    {
        //
        if ($request->ajax()) {
            $data = Reservation::select(['reservations.*','table_lists.table_name','customer_lists.customer_name'])
                ...
                ->orderBy('reservations.reservation_id','desc')->get(); 
    ...
    public function edit($id)
    {
        ...
        $reservation = Reservation::select(['reservations.*','customer_lists.customer_name','customer_lists.email','customer_lists.phone'])
                    ->LeftJoin('customer_lists','reservations.customer_id','=','customer_lists.customer_id')
