...
class SettingsController extends Controller
{
    ...
    public function kitchen_settings(Request $request){
        if($request->input()){
            $request->validate([
                'username'=>'required',
                'status'=>'required',
            ...
            $links = DB::table('kitchen_settings')->update([
            ...
            $data= DB::table('kitchen_settings')->first();
    ...
    public function destroy_contact_query($id)
    {
