...
<section id="banner-section">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="background-image: url('banners/{{$banner->image}}');">
            <div class="row">
                <div class="col-6">
                    <h1>{{$banner->title}}</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 h-100">
                <div  class="category-box">
                    @if($category->image != '')
                    <img src="{{asset('manage_category/'.$category->image)}}" alt="image name">
                    @else
                    <img src="{{asset('manage_category/default.png')}}" alt="image name">
                    @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <a href="{{url('menu/'.str_replace(' ','-',$menu->menu_type))}}" class="menu-box">
                    @if($menu->image != '')
                    <img src="{{asset('menu_type/'.$menu->image)}}" alt="image name">
                    @else
                    <img src="{{asset('menu_type/default.png')}}" alt="image name">
                    @endif
