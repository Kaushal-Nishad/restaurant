        ...
        <div class="card">
            ...
            <div class="body">
                <form class="form-horizontal" id="updateGeneralSetting" method="POST">
                    ...
                    <input type="hidden" class="url" value="{{$item->id}}" >
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            @if($item->logo != '')
                            <img id="logo" src="{{asset('site-images/'.$item->logo)}}" alt="" width="80px" height="80px">
                            @else
                            <img id="logo" src="{{asset('site-images/default.png')}}" alt="" width="80px" height="80px">
                            @endif
                        </div>
                    </div>
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label>Footer Text <small class="text-danger">*</small></label>
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
