                   ...
                   @csrf
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            @if($category->image != "")
                            <img id="image" src="{{asset('manage_category/'.$category->image)}}" alt="" width="80px" height="80px">
                            @else
                            <img id="image" src="{{asset('manage_category/default.jpg')}}" alt="" width="80px" height="80px">
                            @endif
                        </div>
                    </div>
                    <div class="row clearfix">
